...
namespace AltV.Net.WebAssembly.Example
{
    public class Program
    {
        public static void Main(object wrapper)
        {
            ...
            Alt.OnServer("test", (args) => { Alt.Log("test event triggered ");if (args != null) Alt.Log($"{args.Length} args"); });
            Alt.OnServer("test1", (args) => { Alt.Log("test event triggered "); if (args != null) Alt.Log($"{args.Length} args"); });
            Alt.OnServer("test2", (args) => { Alt.Log("test event triggered "); if (args != null) Alt.Log($"{args.Length} args"); });
